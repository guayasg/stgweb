...
insert into menus (id,menu_id,texto,textoayuda,iconopen,iconclosed,metodo) values (10,9,'Familias de los articulos','Gestión de las diferentes familias que categorizan a los articulos','familias-open.png','familias-closed.png','');
...
id serial primary key,
describe character varying(60),
unidadmedida_categoria_id integer references unidadmedida_categorias match full,
...
-- Fin del bloque de unisdades de medida
...
constraint chkre check (impuesto_id is null or (impuesto_id is not null and chktipo='RE'::character(12)
);
...
rop table in exists articulos_lers;
...
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('20104','Residuos plásticos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('20110','Residuos metálicos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('30101','Residuos de corteza y corcho','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('030104*','Serrín, virutas, recortes, madera, tableros de partículas y chapas que contienen sustancias peligrosas','Q12/D15/S40/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('30105','Serrín, virutas, recortes, madera, tableros de partículas y chapas distintos de los mencionados en el código 030104 ','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('080111*','Residuos de pintura y barniz que contienen disolventes orgánicos u otras sustancias peligrosas','Q08/R13/P12/C41/H3B/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('080113*','Lodos de pintura y barniz que contienen disolventes orgánicos u otras sustancias peligrosas','Q08/D15/P12/C43/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('080115*','Lodos acuosos que contienen pintura o barniz con disolventes orgánicos u otras sustancias peligrosas','Q08/R13/LP12/C41/H3-B/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('080117*','Residuos de decapado o eliminación de pintura y barniz que contienen disolventes orgánicos u otras sustancias peligrosas','Q08/R13/P12/C41/H3-B/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('80199','Filtros de cabina de pintura ','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('080312*','Residuos de tintas que contienen sustancias peligrosas ','Q07/D15/L12/C43/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('80313','Residuos de tintas distintos de los especificados en el código 080312','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('080314*','Lodos de tinta que contienen sustancias peligrosas ','Q07/D15/L12/C43/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('080317*','Residuos de tóner de impresión que contienen sustancias peligrosas ','Q14/R13/S12/C43/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('80318','Residuos de tóner de impresión distintos de los especificados en el código 080317','','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('080409*','Residuos de adhesivos y sellantes que contienen disolventes orgánicos u otras sustancias peligrosas','Q07/D15/L13/C41/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('090103*','Soluciones de revelado con disolventes','Q07/D15/L12/C43/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('090104*','Soluciones de fijado ','Q07/D15/L40/C43/H06/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120101','Limaduras y virutas de metales férreos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120103','Limaduras y virutas de metales no férreos ','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120106*','Aceites minerales de mecanizado que contienen halógenos (excepto las emulsiones o disoluciones)','Q07/R13/L08/C40C51/H06/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120107*','Aceites minerales de mecanizado sin halógenos (excepto las emulsiones o disoluciones)','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120108*','Emulsiones y disoluciones de mecanizado que contienen halógenos ','Q07/R13/L08/C40C51/H06/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120109*','Emulsiones y disoluciones de mecanizado sin halógenos','Q07/D15/L09/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120110*','Aceites sintéticos de mecanizado','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120112*','Ceras y grasas usadas','Q07/D15/P19/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120114*','Lodos de mecanizado que contienen sustancias peligrosas','Q08/D15/S08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120116*','Residuos de granallado o chorreado que contienen sustancias peligrosas (polvo de lijado)','Q08/D15/S25/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120118*','Lodos metálicos (lodos de esmerilado, rectificado y lapeado) que contienen aceites','Q08/D15/S08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120119*','Aceites de mecanizado fácilmente biodegradables','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120120*','Muelas y materiales de esmerilado usados que contienen sustancias peligrosas ','Q05/D15/S09/C51C41/H05/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('120121','Muelas y materiales de esmerilado usados distintos de los especificados en el código 12 01 20 ',' ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130104*','Emulsiones cloradas','Q07/R13/L08/C40C51/H06/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130105*','Emulsiones no cloradas ','Q07/D15/L09/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130109*','Aceites hidráulicos minerales clorados','Q07/R13/L08/C40C51/H06/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130110*','Aceites hidráulicos minerales no clorados ','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130111*','Aceites hidráulicos sintéticos','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130112*','Aceites hidráulicos fácilmente biodegradables','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130113*','Otros aceites hidráulicos','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130204*','Aceites minerales clorados de motor, de transmisión mecánica y lubricantes ','Q07/R13/L08/C40C51/H06/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130205*','Aceites minerales no clorados de motor, de transmisión mecánica y lubricantes','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130206*','Aceites sintéticos de motor, de transmisión mecánica y lubricantes','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130207*','Aceites fácilmente biodegradables de motor, de transmisión mecánica y lubricantes','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130208*','Otros aceites de motor, de transmisión mecánica y lubricantes ','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130501*','Sólidos procedentes de separadores','Q12/D15/S23/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130502*','Lodos del separador de agua /sustancias aceitosas','Q08/D15/P08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130506*','Sólidos procedentes de los desarenadotes y de separadores de aguas/sustancias aceitosas ','Q07/R13/L08/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130507*','Agua aceitosa procedente de separadores de agua/sustancias aceitosas','Q07/D15/L09/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130508*','Mezcla de residuos procedentes de desarenadores y de separadores de agua / sustancias aceitosas','Q07/D15/L09/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130702*','Gasolinas ','Q08/R13/L09/C51/H3B/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130701*','Gasóleos','Q08/R13/L09/C51/H3A/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('130703*','Otros combustibles (incluidas mezclas)','Q08/R13/L09/C51/H3-A/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('140601*','Clorofluorocarbonos, CFC, HFC (fluidos del sistema de aire acondicionado, gas licuado)','Q07/D15/L05/C40/H06/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('140602*','Disolventes y mezclas de disolventes halogenados ','Q07/R13/L05/C40/H06/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('140603*','Otros disolventes y mezclas de disolventes','Q07/R13/L05/C41/H3-B/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('140604*','Lodos o residuos sólidos que contienen disolventes halogenados','Q07/D15/L05/C40/H06/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('140605*','Lodos o residuos sólidos que contienen otros disolventes','Q07/D15/L40/C43/H06/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150101','Envases de papel y cartón','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150102','Envases de plástico','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150103','Envases de madera','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150104','Envases metálicos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150105','Envases compuestos','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150106','Envases mezclados','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150107','Envases de vidrio','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150109','Envases textiles','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150110*','Envases plásticos que contienen restos de sustancias peligrosas','Q05/R13/S36/C51C41/H05/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150111*','Envases metálicos con restos de sustancias peligrosas  ','Q05/R13/S36/C51C41/H05/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('150202*','Absorbentes, materiales de filtración (incluidos los filtros de aceite no especificados en otra categoría), trapos de limpieza y ropas protectoras contaminados por sustancias peligrosas','Q05/D15/S09/C51C41/H05/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160103','Neumáticos fuera de uso','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160106','Vehículos al final de su vida útil que no contengan sustancias peligrosas','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160107*','Filtros de aceite','Q06/R04/S35/C51/H05/A0000935/B9703','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160108*','Componentes que contengan mercurio  ','Q16/R13/S37/C16/H06/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160113*','Líquido de frenos','Q14/R13/L40/C43/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160114*','Líquidos de refrigeración y anticongelante','Q14/R13/L40/C43/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160117','Metales ferrosos','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160118','Metales no ferrosos    ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160119','Plástico','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160120','Vidrio','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160211*','Equipos desechados que contienen clorofluorocarbonos, HCFC, HFC','Q16/D15/S40/C05/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160213*','Equipos eléctricos y electrónicos desechados que contienen componentes peligrosos (distintos de los especificados en los códigos de 160209* a 160212*)   ','Q16/D15/S40/C06/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160214','Equipos eléctricos y electrónicos desechados distintos de los especificados en los códigos de 160209* a 160213*)  ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160215*','Componentes peligrosos retirados de equipos desechados ','Q16/D15/S40/C06/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160216','Componentes retirados de equipos desechados, distintos de los especificados en el código 160215*','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160504*','Gases en recipientes a presión (incluidos los halones) que contienen sustancias peligrosas','Q14/D15/S39/C40/H3-B/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160506*','Productos químicos de laboratorio que consisten en, o contienen, sustancias peligrosas, incluidas las mezclas de productos químicos de laboratorio','Q03/D15/L40/C23C41/H06/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160507*','Productos químicos inorgánicos desechados que consisten en, o contienen, sustancias peligrosas','Q03/D15/L40/C23C41/H06/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160508*','Productos químicos orgánicos desechados que consisten en, o contienen, sustancias peligrosas  ','Q03/D15/L40/C23C41/H06/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160601*','Baterías de plomo','Q06/R04/S37/C23C18/H06H08/A0000961/B9703','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160602*','Acumuladores de Ni-Cd  ','Q16/R13/S37/C05C11/H06/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160603*','Pilas que contienen mercurio (botón)','Q16/R13/S37/C16/H06/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160604','Pilas alcalinas (excepto las del código 160603*-Hg)','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160605','Otras pilas y acumuladores   ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160708*','Residuos que contienen hidrocarburos','Q07/D15/L09/C51/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160801','Catalizadores usados que contienen oro, plata, renio, rodio, paladio, iridio o platino (excepto los del código 160807)  ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160802*','Catalizadores que contienen metales de transición peligrosos o compuestos de metales de transición peligrosos     ','Q14/D15/S26/C18/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160803','Catalizadores usados que contienen metales de transición o compuestos de metales de transición no especificados en otra categoría    ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170101','Hormigón','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170102','Ladrillos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170103','Tejas y materiales cerámicos ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170106*','Mezclas, o fracciones separadas, de hormigón, ladrillos, tejas y materiales cerámicos que contienen sustancias peligrosas','Q12/D15/S23/C51/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170107','Mezclas, o fracciones separadas, de hormigón, ladrillos, tejas y materiales cerámicos distintas de las especificadas en el código 170106    ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170201','Madera','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170202','Vidrio','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170203','Plástico','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170204*','Vidrio, plástico y madera que contienen sustancias peligrosas o están contaminados por ellas  ','Q12/R13/S36/C51/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170401','Cobre, bronce, latón   ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170402','Aluminio','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170403','Plomo','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170405','Hierro y acero','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170406','Estaño','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170407','Metales mezclados','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170411','Cables de cobre y cables de aluminio (considerados como metales incluidos en los residuos de la construcción y demolición)     ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170503*','Tierra y piedras que contienen sustancias peligrosas   ','Q12/D15/S23/C51/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170601*','Materiales de aislamiento que contienen amianto  ','Q07/D15/S12/C25/H06/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170801*','Material de construcción a partir de yeso contaminado con sustancias peligrosas  ','Q12/D15/S23/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170802','Materiales de construcción a partir de yeso distintos de los especificados en el código 170801','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170903*','Otros residuos de construcción y demolición (incluidos los residuos mezclados) que contienen sustancias peligrosas','Q12/R15/S23/C51/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170904','Residuos mezclados de construcción y demolición distintos de los especificados en los códigos 170901, 170902 y 170903','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('190102','Materiales férreos separados de la ceniza de fondo de horno','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('190205*','Lodos de tratamientos físico-químicos que contienen sustancias peligrosas  ','Q09/D15/S27/C24/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('190501','Fracción no comportada de residuos municipales y asimilados. Residuos del tratamiento aeróbico de residuos sólidos.','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('191001','Residuos de hierro y acero','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('191002','Residuos no férreos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('191202','Metales férreos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('191203','Metales no férreos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200101','Papel y cartón','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200102','Vidrio','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200114*','Ácidos','Q07/D15/L27/C23/H08/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200117*','Productos fotoquímicos ','Q07/D15/L40/C43/H06/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200121*','Tubos fluorescentes y otros residuos que contienen mercurio   ','Q14/D15/S40/C16/H05/A936(9)/B0019','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200125','Aceites y grasas comestibles ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200133*','Baterías y acumuladores especificados en los códigos 160601, 160602 o 160603 y baterías y acumuladores sin clasificar que contienen esas baterías ','Q06/R13/S37/C18C23/H08/A936(9)/B0019 ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200134','Baterías y acumuladores distintos de los especificados en el código 200133 ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200135*','Equipos eléctricos y electrónicos desechados, distintos de los especificados en los códigos 200121 y 200123, que contienen componentes peligrosos ','Q16/D15/S40/C06/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200136','Equipos eléctricos y electrónicos desechados distintos de los especificados en los códigos 200121, 200123 y 200135','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200137*','Madera que contiene sustancias peligrosas ','Q12/D15/S40/C51/H05/A936(9)/B0019    ','t');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200138','Madera distinta de la especificada en el código 200137 ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200139','Plásticos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200140','Metales','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200201','Residuos biodegradables de parques y jardines    ','     ','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200301','Mezcla de residuos municipales','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('200307','Residuos voluminosos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('0','NO ES UN RESIDUO. NO DEBE DE ESTAR EN STOCK','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160199','Residuos no especificados en otra categoria (Esteriles de rechazo)  ','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160118','Metales no ferrosos','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('160601','Baterias de plomo','','f');
Insert into articulos_lers (codlerpeligroso, codman,describe) values ('170404','Zinc','','f');
...
describe character varying(100) not null,
componernombre boolean not null default true,
...
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (1,null,'00001','Colchón',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (2,null,'00002','Base',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (3,null,'00003','Complementos',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (4,null,'00004','Textil',False);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (7,null,'00007','Repuestos',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (8,null,'00008','Marketing',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (9,null,'00009','Servicios',false);

insert into familias (id,padre_id,codfamilia,describe,componernombre) values (11,1,'00011','Colchón muelles',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (12,1,'00012','Colchón no muelles',false);

insert into familias (id,padre_id,codfamilia,describe,componernombre) values (13,11,'00013','Muelle semicilíndrico',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (14,11,'00014','Muelle cilíndrico',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (15,11,'00015','Muelle compactado',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (16,11,'00015','Muelle Ensacado',false);

insert into familias (id,padre_id,codfamilia,describe,componernombre) values (17,12,'00016','Espuma 1 capa',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (18,12,'00017','Espuma 2 capas',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (19,12,'00018','Espuma 3 capas',true);


insert into familias (id,padre_id,codfamilia,describe,componernombre) values (21,2,'00021','Tapis',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (22,2,'00022','Canapés',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (23,2,'00023','Arcones',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (24,2,'00024','Mixtos',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (25,2,'00025','Box Springs',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (26,2,'00026','Nidos',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (27,2,'00027','Camas Eléctricas',false);

insert into familias (id,padre_id,codfamilia,describe,componernombre) values (31,3,'00031','Acabados',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (32,3,'00032','Cabeceros',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (33,3,'00033','Patas',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (34,3,'00034','Almohadas',false);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (35,3,'00035','Topper',false);

insert into familias (id,padre_id,codfamilia,describe,componernombre) values (81,8,'00081','Catálogos',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (82,8,'00082','Tarifas',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (83,8,'00083','Muestrarios',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (84,8,'00084','PLV',true);

insert into familias (id,padre_id,codfamilia,describe,componernombre) values (91,9,'00091','Visita comercial',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (92,9,'00092','Comisión',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (93,9,'00093','Transporte',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (94,9,'00094','Distribución',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (95,9,'00095','Montaje',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (96,9,'00096','Incidencias',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (97,9,'00097','Vertedero',true);
insert into familias (id,padre_id,codfamilia,describe,componernombre) values (98,9,'00098','Asistencia técnica',true);
...
/*
--colores id,padre_id default null,familia,componernombre boolean,tieneSN)
DROP TABLE IF EXISTS colorestipos; --Grupos de medidas
create table colorestipos(
id serial primary key,
describe character varying(100) not null,
);
...
id serial primary key,
idcolortipo integer references colorestipos(id)
codcolor character varying(5) not null,
describe character varying(100) not null,

);

-- Definición de medidas
DROP TABLE IF EXISTS medidastipos; --Grupos de medidas
create table medidastipos(
id serial primary key,
describe character varying(100) not null,
);
...
id serial primary key,
idmedidatipo integer references medidastipos(id),
codmedida character varying(5) not null,
describe character varying(100) not null,
);
...
insert into propiedades_componer (id,describe) values (1,'ninguno');
insert into propiedades_componer (id,describe) values (2,'cod');
insert into propiedades_componer (id,describe) values (3,'propiedad');
insert into propiedades_componer (id,describe) values (4,'valor');
insert into propiedades_componer (id,describe) values (5,'cod + propiedad');
insert into propiedades_componer (id,describe) values (6,'cod + valor');
insert into propiedades_componer (id,describe) values (7,'cod + propiedad + valor');
insert into propiedades_componer (id,describe) values (8,'propiedad + valor');
select setval('propiedades_componer_id_seq',max(id)) from propiedades_componer;

DROP TABLE IF EXISTS propiedades; --Propiedades que pueden tener los artículos, aunque en realidad van vinculadas a los grupos en las familias
...
/*
--Si una determinada propiedad está presente en esta tabla, significará que es una propiedad calculada
drop table if exists propiedades_links;
create table propiedades_links(
id serial,
propiedad_calculada_id integer references propiedades (id) match full,
propiedad_link_id integer references propiedades(id) match full,
operador character(5), -- Este campo contendrá un +, *, o lo que sea, de tal forma que todas las propiedades apuntadas por el mismo propiedad_caclculada_id, se operen con él
entidad_id integer references entidades(id) match simple default null --Si el id es no  nulo, significa que el valor de la propiedad es una entidad (por ejemplo proveedor)
);
...
/*
DROP TABLE IF EXISTS propiedades_packs; --
create table propiedades_packs( -- 
id serial primary key,
describe character varying(200) not null default ''
);

comment on table propiedades_packs is 'Aquí se define un nombre para una agrupación de propiedades valores. 
					Algo así como la cabecera de propiedades y valores preconfigurados. Por ejemplo Medidas de colchones';

insert into propiedades_packs (id,describe) values (1,'Medidas de colchones');
insert into propiedades_packs (id,describe) values (2,'Modelos de colchones Aspol');
select setval('propiedades_id_seq',max(id)) from propiedades_packs;

DROP TABLE IF EXISTS propiedades_packs_lineas; --
create table propiedades_packs_lineas( -- 
id serial primary key,
propiedad_pack_id integer references propiedades_packs(id) match full,
propiedad_id integer references propiedades(id) match full on update cascade on delete cascade,
valor character varying(200),
--entidades_id references entidades(id) match simple default null -- si este vínculo existe, la propiedad indica que apunta a un proveedor
unique (propiedad_id,valor)
);
comment on table propiedades_packs_lineas is 'Detalles de un pack de propiedaes.
        Sería todos los pares propiedad<->valor de un pack de propiedades valores. Las propiedades con igual grupo pertenecen al mismo artículo. 
        Indica por cada conjunto de registros con el mismo grupo, que son un conjunto de propiedades que definen al mismo artículo. No se han de poder repetir en cada grupo, una propiedad';
       

insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (1,1,'182');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (1,1,'190');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (1,1,'200');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (1,1,'210');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (1,1,'220');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'80');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'90');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'100');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'105');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'120');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'135');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'140');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'160');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'180');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (2,1,'200');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'182 x 80');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'182 x 90');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'182 x 100');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'190 x 105');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'190 x 120');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'190 x 135');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'200 x 140');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'200 x 150');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'200 x 160');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'210 x 180');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'210 x 200');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'220');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (10,1,'Especial');

insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (26,2,'Iria');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (26,2,'Colliseum');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (26,2,'Canarias');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (26,2,'Canarias2');
insert into propiedades_packs_lineas(propiedad_id,propiedad_pack_id,valor) values (26,2,'Cies');


-- Insertar propiedades de tipo proveedor. Vincular

select setval('propiedades_packs_lineas_id_seq',max(id)) from propiedades_packs_lineas;

*/

/*

DROP TABLE IF EXISTS propiedades_packs_lineas_incompatibles; -- contiene incompatibilidades entre valores de propiedades. Útil para crear los grupos de propiedades valores
create table propiedades_packs_lineas_incompatibles( -- 
id serial primary key,
ppl_id integer references propiedades_packs_lineas(id) match full on update cascade on delete cascade,
ppl2_id integer references propiedades_packs_lineas(id) match full on update cascade on delete cascade,
valor character varying(200),
--entidades_id references entidades(id) match simple default null -- si este vínculo existe, la propiedad indica que apunta a un proveedor
unique (ppl_id,ppl2_id)
);
*/
...
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (1,1,1,'182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (2,1,1,'190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (3,1,1,'200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (4,1,1,'210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (5,1,1,'220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (6,2,1,'80');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (7,2,1,'90');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (8,2,1,'100');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (9,2,1,'105');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (10,2,1,'120');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (11,2,1,'135');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (12,2,1,'140');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (13,2,1,'150');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (14,2,1,'160');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (15,2,1,'180');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (16,2,1,'200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (17,10,1,' 80 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (18,10,1,' 90 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (19,10,1,'100 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (20,10,1,'105 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (21,10,1,'120 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (22,10,1,'135 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (23,10,1,'140 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (24,10,1,'150 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (25,10,1,'160 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (26,10,1,'180 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (27,10,1,'200 x 182');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (28,10,1,' 80 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (29,10,1,' 90 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (30,10,1,'100 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (31,10,1,'105 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (32,10,1,'120 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (33,10,1,'135 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (34,10,1,'140 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (35,10,1,'150 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (36,10,1,'160 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (37,10,1,'180 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (38,10,1,'200 x 190');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (39,10,1,' 80 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (40,10,1,' 90 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (41,10,1,'100 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (42,10,1,'105 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (43,10,1,'120 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (44,10,1,'135 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (45,10,1,'140 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (46,10,1,'150 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (47,10,1,'160 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (48,10,1,'180 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (49,10,1,'200 x 200');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (50,10,1,' 80 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (51,10,1,' 90 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (52,10,1,'100 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (53,10,1,'105 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (54,10,1,'120 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (55,10,1,'135 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (56,10,1,'140 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (57,10,1,'150 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (58,10,1,'160 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (59,10,1,'180 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (60,10,1,'200 x 210');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (61,10,1,' 80 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (62,10,1,' 90 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (63,10,1,'100 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (64,10,1,'105 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (65,10,1,'120 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (66,10,1,'135 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (67,10,1,'140 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (68,10,1,'150 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (69,10,1,'160 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (70,10,1,'180 x 220');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (71,10,1,'200 x 220');


insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (72,10,1,'Especial');



insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (73,23,16,'Iria'); --muelle ensacado
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (74,23,16,'Colliseum');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (75,23,17,'Canarias');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (76,23,17,'Canarias2');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (77,23,16,'Cies');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (78,23,15,'Tambre');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (79,23,13,'Alfa');
insert into familias_propiedades(id,propiedad_id,familia_id,valor) values (80,23,14,'Granada');


select setval('familias_propiedades_id_seq',max(id)) from familias_propiedades;
...
insert into familias_valoresligados (fp_id,fp2_id) values (1,17);
insert into familias_valoresligados (fp_id,fp2_id) values (1,18);
insert into familias_valoresligados (fp_id,fp2_id) values (1,19);
insert into familias_valoresligados (fp_id,fp2_id) values (1,20);
insert into familias_valoresligados (fp_id,fp2_id) values (1,21);
insert into familias_valoresligados (fp_id,fp2_id) values (1,22);
insert into familias_valoresligados (fp_id,fp2_id) values (1,23);
insert into familias_valoresligados (fp_id,fp2_id) values (1,24);
insert into familias_valoresligados (fp_id,fp2_id) values (1,25);
insert into familias_valoresligados (fp_id,fp2_id) values (1,26);
insert into familias_valoresligados (fp_id,fp2_id) values (1,27);
insert into familias_valoresligados (fp_id,fp2_id) values (2,28);
insert into familias_valoresligados (fp_id,fp2_id) values (2,30);
insert into familias_valoresligados (fp_id,fp2_id) values (2,31);
insert into familias_valoresligados (fp_id,fp2_id) values (2,33);
insert into familias_valoresligados (fp_id,fp2_id) values (2,34);
insert into familias_valoresligados (fp_id,fp2_id) values (2,35);
insert into familias_valoresligados (fp_id,fp2_id) values (2,36);
insert into familias_valoresligados (fp_id,fp2_id) values (2,37);
insert into familias_valoresligados (fp_id,fp2_id) values (2,38);
insert into familias_valoresligados (fp_id,fp2_id) values (3,39);
insert into familias_valoresligados (fp_id,fp2_id) values (3,40);
insert into familias_valoresligados (fp_id,fp2_id) values (3,41);
insert into familias_valoresligados (fp_id,fp2_id) values (3,42);
insert into familias_valoresligados (fp_id,fp2_id) values (3,43);
insert into familias_valoresligados (fp_id,fp2_id) values (3,44);
insert into familias_valoresligados (fp_id,fp2_id) values (3,45);
insert into familias_valoresligados (fp_id,fp2_id) values (3,46);
insert into familias_valoresligados (fp_id,fp2_id) values (3,47);
insert into familias_valoresligados (fp_id,fp2_id) values (3,48);
insert into familias_valoresligados (fp_id,fp2_id) values (3,49);
insert into familias_valoresligados (fp_id,fp2_id) values (4,50);
insert into familias_valoresligados (fp_id,fp2_id) values (4,51);
insert into familias_valoresligados (fp_id,fp2_id) values (4,52);
insert into familias_valoresligados (fp_id,fp2_id) values (4,53);
insert into familias_valoresligados (fp_id,fp2_id) values (4,54);
insert into familias_valoresligados (fp_id,fp2_id) values (4,55);
insert into familias_valoresligados (fp_id,fp2_id) values (4,56);
insert into familias_valoresligados (fp_id,fp2_id) values (4,57);
insert into familias_valoresligados (fp_id,fp2_id) values (4,58);
insert into familias_valoresligados (fp_id,fp2_id) values (4,59);
insert into familias_valoresligados (fp_id,fp2_id) values (4,60);
insert into familias_valoresligados (fp_id,fp2_id) values (5,61);
insert into familias_valoresligados (fp_id,fp2_id) values (5,62);
insert into familias_valoresligados (fp_id,fp2_id) values (5,63);
insert into familias_valoresligados (fp_id,fp2_id) values (5,64);
insert into familias_valoresligados (fp_id,fp2_id) values (5,65);
insert into familias_valoresligados (fp_id,fp2_id) values (5,66);
insert into familias_valoresligados (fp_id,fp2_id) values (5,67);
insert into familias_valoresligados (fp_id,fp2_id) values (5,68);
insert into familias_valoresligados (fp_id,fp2_id) values (5,69);
insert into familias_valoresligados (fp_id,fp2_id) values (5,70);
insert into familias_valoresligados (fp_id,fp2_id) values (5,71);
insert into familias_valoresligados (fp_id,fp2_id) values (6,17);
insert into familias_valoresligados (fp_id,fp2_id) values (6,28);
insert into familias_valoresligados (fp_id,fp2_id) values (6,39);
insert into familias_valoresligados (fp_id,fp2_id) values (6,50);
insert into familias_valoresligados (fp_id,fp2_id) values (6,61);
insert into familias_valoresligados (fp_id,fp2_id) values (7,18);
insert into familias_valoresligados (fp_id,fp2_id) values (7,29);
insert into familias_valoresligados (fp_id,fp2_id) values (7,40);
insert into familias_valoresligados (fp_id,fp2_id) values (7,51);
insert into familias_valoresligados (fp_id,fp2_id) values (7,63);
insert into familias_valoresligados (fp_id,fp2_id) values (8,19);
insert into familias_valoresligados (fp_id,fp2_id) values (8,30);
insert into familias_valoresligados (fp_id,fp2_id) values (8,41);
insert into familias_valoresligados (fp_id,fp2_id) values (8,52);
insert into familias_valoresligados (fp_id,fp2_id) values (8,63);
insert into familias_valoresligados (fp_id,fp2_id) values (9,20);
insert into familias_valoresligados (fp_id,fp2_id) values (9,31);
insert into familias_valoresligados (fp_id,fp2_id) values (9,42);
insert into familias_valoresligados (fp_id,fp2_id) values (9,53);
insert into familias_valoresligados (fp_id,fp2_id) values (9,64);
insert into familias_valoresligados (fp_id,fp2_id) values (10,21);
insert into familias_valoresligados (fp_id,fp2_id) values (10,32);
insert into familias_valoresligados (fp_id,fp2_id) values (10,43);
insert into familias_valoresligados (fp_id,fp2_id) values (10,54);
insert into familias_valoresligados (fp_id,fp2_id) values (10,65);
insert into familias_valoresligados (fp_id,fp2_id) values (11,22);
insert into familias_valoresligados (fp_id,fp2_id) values (11,33);
insert into familias_valoresligados (fp_id,fp2_id) values (11,44);
insert into familias_valoresligados (fp_id,fp2_id) values (11,55);
insert into familias_valoresligados (fp_id,fp2_id) values (11,66);
insert into familias_valoresligados (fp_id,fp2_id) values (12,23);
insert into familias_valoresligados (fp_id,fp2_id) values (12,34);
insert into familias_valoresligados (fp_id,fp2_id) values (12,45);
insert into familias_valoresligados (fp_id,fp2_id) values (12,56);
insert into familias_valoresligados (fp_id,fp2_id) values (12,67);
insert into familias_valoresligados (fp_id,fp2_id) values (13,24);
insert into familias_valoresligados (fp_id,fp2_id) values (13,35);
insert into familias_valoresligados (fp_id,fp2_id) values (13,46);
insert into familias_valoresligados (fp_id,fp2_id) values (13,57);
insert into familias_valoresligados (fp_id,fp2_id) values (13,68);
insert into familias_valoresligados (fp_id,fp2_id) values (14,25);
insert into familias_valoresligados (fp_id,fp2_id) values (14,36);
insert into familias_valoresligados (fp_id,fp2_id) values (14,47);
insert into familias_valoresligados (fp_id,fp2_id) values (14,58);
insert into familias_valoresligados (fp_id,fp2_id) values (14,69);
insert into familias_valoresligados (fp_id,fp2_id) values (15,26);
insert into familias_valoresligados (fp_id,fp2_id) values (15,37);
insert into familias_valoresligados (fp_id,fp2_id) values (15,48);
insert into familias_valoresligados (fp_id,fp2_id) values (15,59);
insert into familias_valoresligados (fp_id,fp2_id) values (15,70);
...
id serial primary key,
grupo_id integer references articulos_grupopropiedades(id) match full on delete cascade,
...
-- El artículo estará relacionado por el campo grupo a articulos_grupospropiedades. Por trigger se comprobará que eliminar un grupo eliine si se puede, el artículo vinculado.




/*
DROP TABLE IF EXISTS familias_grupos_propiedades;

create table familias_grupos_propiedades( --Cada familia puede tener un conjunto de propiedades-valores, provenientes de propiedades_packs 

  id serial primary key,												 
  familia_id integer references familias(id) match full,
  padre_id integer references familias_grupos_propiedades(id) match simple default null,
  propia boolean default true,
  competencia boolean default false
);

comment on table familias_grupos_propiedades is 'Vinculación a la familia de los artículo toda la combinatoria (dominio) de propiedades y valores (provienen de los packs de propiedades).
        Las propiedades con igual grupo pertenecen al mismo artículo. 
        Indica por cada conjunto de registros con el mismo grupo, que son un conjunto de propiedades que definen al mismo artículo. No se han de poder repetir en cada grupo, un propiedad_id.';


drop table if exists familias_grupos_propiedades;
create table familias_grupos_propiedades(
id serial,
grupo serial,
familia_id integer references familias(id) match full,
ppl_id integer references propiedades_packs_lineas(id) match simple default null, --puede ser que no haya valor definido
fp_id integer references familias_propiedades(id) match full
);

CREATE INDEX idx_familias_grupos_propiedades_familia_id ON familias_grupos_propiedades USING btree (familia_id,grupo);
CREATE INDEX idx_familias_grupos_propiedades_ppl_id ON familias_grupos_propiedades USING btree (ppl_id);
CREATE INDEX idx_familias_grupos_propiedades_fp_id ON familias_grupos_propiedades USING btree (fp_id);
*/

/*
DROP TABLE IF EXISTS familias_grupos_propiedades_detalles;        
create table familias_grupos_propiedades_detalles(
  id serial primary key,
  propiedad_pack_linea_id integer references propiedades_packs_lineas(id) match full,
  propiedad_grupo_id integer references familias_grupos_propiedades(id) match full,
  orden serial
);
comment on table familias_grupos_propiedades_detalles is 'El orden especifica como se conformará el nombre y código del artículo al crear el artículo basada en esta familia. Esto es, cual de las propiedades tendrá prioridad para conformar 
        el código y la descripción del artículo. Recordar que el código y nombre del artículo se crean conforme se recorre la familia y las  propiedades de la misma que tengan el campo componernombre=true
        en la familia, y propcomponernombre=true en el de propiedad.';
 */

-- Harán falta utilidades en la asociación del pack de propiedades a la familia. Utilidades como:
-- 1) Crear un nuevo grupo de propiedades. Aparecerá una búsqeda de packs->y los detalles del pack de propiedades. En dicha búsqueda no aparecerá (ni será posible) vincular una propiedad, o propiedad-valor 
--	de familias ascendentes (o descendientes a la actual). ver: 
-- 2) Si se asocia una sóla línea del pack, y seguidamente, en la búsqueda no será posible seleccionar una línea con alguna propiedad ya vinculada (independientemente del campo "valor" de dicha propiedad)
-- 3) En la búsqueda no aparecerán en ningún caso líneas del pack ya vinculadas a la familia. Se comprueba por trigger. vease familias_grupos_propiedades_detalles_validaciones
-- 4) Posiblidad de ordenar la lista de líneas provenientes de detalles del pack dentro del grupo y familia
-- 5) Posibilidad de crear el artículo automáticamente partiendo del grupo, conforme a las propiedades 
-- 6) el valor de las propiedades volumen con id 16,17,18 (volumen producto,embalaje, y transporte respectivamente) ha de poder calcularse automáticamente como el producto en cada caso de las propiedades 1,2,3 (largo x ancho x alto del producto), 4,5, 6 (largo x ancho x alto del transporte), y 7, 8, 9 (largo x ancho x alto del embalaje).
-- Ve DB mod_propiedades.sql


/*
CREATE INDEX idx_familias_propiedades_idfamilia ON familias_propiedades USING btree (idfamilia);
CREATE INDEX idx_familias_propiedades_propiedad_id_packlinea ON familias_propiedades USING btree (idpropiedadpacklinea);
*/
--Articulos id,idfamilia (contiene el idsubfamilia al que pertenece),idunidadmedida,bultos,fechabaja,fechaalta,idgrupoventa,refalternativa
...
id serial primary key,
grupo_id integer references familias_grupos_propiedades(id),
unidadmedida_id integer not  null default 0 references unidadmedidas match full on update cascade,
bultos integer default 1 check( when ctrlstk then bultos>0 end ),
...
unidadmedida_categoria_id references unidadmedida_categorias(id) match full,
...
impuesto_id references impuestos(id) match full default 1,
bultos integer,
...
CREATE INDEX idx_articulos_familia_id ON articulos USING btree (codgrupoventa);
CREATE INDEX idx_articulos_nomcomercial ON articulos USING btree (nomcomercial);
CREATE INDEX idx_articulos_medida_id ON articulos USING btree (medida_id);
CREATE INDEX idx_articulos_refalternativa ON articulos USING btree (refalternativa);
CREATE INDEX idx_articulos_codbarra ON articulos USING btree (codbarra);


drop table if exists articulos_gruposventas; --Tarifas de venta, y asociación de los artículos que puede manejar cada grupo de cliente
...
create index idx_articulos_series_serie_id on articulos_series using (serie_id);
...
insert into series (id,serie) values (1,'COM');
insert into series (id,serie) values (2,'HIP');
insert into series (id,serie) values (3,'ECI');
insert into series (id,serie) values (4,'MKM');
insert into series (id,serie) values (5,'ASP');
insert into series (id,serie) values (6,'EXP');
...
DROP TABLE IF EXISTS almacenes_estados; --indica el estado de las piezas en almacén. por ejemplo: en préstamo,por reparación,por intercambio,por no operativa
...
CREATE unique INDEX idx_almacenes_describe ON almacenes USING btree (describe);
...
direnvio_id integer default null references direcciones(id) match full, 
...
refentidad character(50) default null, --referencia del documento de la entidad a la que estamos vinculados (mUumero factura de proveedor, talón de venta...)
...
id serial primary key,
iddocumento integer not null references documentos(id) match full,
observacion character varying(500) not null default '';
...
id serial primary key,
idarticulo integer not null references documentos(id) match full,
observacion character varying(500) not null default '';
);
CREATE unique INDEX idx_articulos_obs_idarticulo ON articulos_obs USING btree (iddocumento);
...
CREATE unique INDEX idx_stocks_almacen_id_articulo_id ON stocks USING btree (almacen_id,articulo_id,lote_id,fechavencimiento_id);
